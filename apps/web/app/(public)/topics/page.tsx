 ...
 * business content and has no session dependency (AD-8). No `dark:` variants
 * (theme cleanup is 1.3).
 */
export default function TopicsPlaceholderPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      <header className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">主题</h1>
        <p className="text-lg text-neutral-600">AGUHOT · 按主题浏览热点</p>
      </header>
