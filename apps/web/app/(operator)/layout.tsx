 ...
 *   2. (Auth gate REMOVED here) — the real auth gate lives in `proxy.ts`
 *      (the primary request-time gate, covering BOTH GET and POST) and in each
 *      server action's first-line `isOperatorAuthenticated()` check (defense-in-depth
