/**
 * search-read module barrel — Story 3.1 (FR12 public search); Story 4.4 adds
 * the timeline corpus.
 *
 ...
 * listPublishedHotEventExplanations + listPublishedThemeMemberships +
 * listPublishedTimelineEntries (all filter-free sibling list fns owned by
 * publish-orchestrator) and matches + ranks in JS. The Prisma client lives one
